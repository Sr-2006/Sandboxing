...
public class GlobalExceptionHandlerTest {
    ...
    void testExceptionHandlerPreservesMDCTrace() {
        ...
        Exception testException = new RuntimeException("Simulated order processing failure");
        ...
        assertEquals("Simulated order processing failure", response.getBody().get("message"));
