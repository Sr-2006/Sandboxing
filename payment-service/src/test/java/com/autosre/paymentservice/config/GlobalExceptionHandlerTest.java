...
public class GlobalExceptionHandlerTest {
    ...
    void testExceptionHandlerPreservesMDCTrace() {
        ...
        Exception testException = new RuntimeException("Payment processing network timeout");
        ...
        assertEquals("Payment processing network timeout", response.getBody().get("message"));
